...
namespace YFrameWork
{
        ...
        where T : BaseApp<T>
    {
        ...
        sealed public override void OnSingletonInit()
        {
            ...
            if(OnInitApp != null) OnInitApp.Invoke(mInstance);
    ...
    /// 表现层接口
    /// </summary>
    public interface IController : IGetApp, ISendCommand, IGetSystem, IGetModel, ISendEvent, IRegisterEvent, ISendQuery
    {
    ...
    /// 系统层接口
    /// </summary>
    public interface ISystem : IGetApp, ISetApp, IGetModel, IGetUtility, IGetSystem, ISendEvent, IRegisterEvent
    {
        void Init();
    }
    ...
    /// 命令接口(用于关联模型和表现层)
    /// </summary>
    public interface ICommand : IGetApp, ISetApp, ISendQuery, IGetSystem, IGetModel, IGetUtility, ISendEvent, ISendCommand
    {
        void Init();
        void Execute();
    }
    ...
    /// 模型接口
    /// </summary>
    public interface IModel : IGetApp, ISetApp, IGetUtility, ISendEvent
    {
        void Init();
    }
    ...
    #region Query
    public interface IQuery<TResult> : IGetApp, ISendQuery, ISetApp, IGetModel, IGetSystem
    {
        TResult Do();
    }
    ...
    /// 获取系统接口
    /// </summary>
    public interface IGetSystem : IGetApp
    {
    ...
    /// 获取模型接口
    /// </summary>
    public interface IGetModel : IGetApp
    {
    ...
    /// 获取工具接口
    /// </summary>
    public interface IGetUtility : IGetApp
    {
    ...
    /// 发送命令接口
    /// </summary>
    public interface ISendCommand : IGetApp
    {
    ...
    /// 注册事件接口
    /// </summary>
    public interface IRegisterEvent : IGetApp
    {
    ...
    /// 发送事件接口
    /// </summary>
    public interface ISendEvent : IGetApp
    {
    ...
    /// 获取模型接口
    /// </summary>
    public interface ISendQuery : IGetApp
    {
    ...
    {
        public BindableProperty(T defVal)
        {
            _value = defVal;
        }
        ...
        public T Value
        {
            ...
            set
            {
                if (value == null || !value.Equals(_value))
                {
                    T oldVal = _value;
                    _value = value;
                    if(_onValueChanged!= null) _onValueChanged.Invoke(new BindablePropChangedEvent<T> { oldVal = oldVal, newVal = value });
                }
            }
        }

        public IUnRegister Register(Action<BindablePropChangedEvent<T>> onValueChanged)
        {
        ...
        public IUnRegister RegisterByDef(Action<BindablePropChangedEvent<T>> onValueChanged)
        {
            onValueChanged(new BindablePropChangedEvent<T> { oldVal = _value, newVal = _value });
            return Register(onValueChanged);
        }

        public void UnRegister(Action<BindablePropChangedEvent<T>> onValueChanged)
        {
            _onValueChanged -= onValueChanged;
        }
        ...
        private Action<BindablePropChangedEvent<T>> _onValueChanged = (v) => { };
        private T _value;
    }

    public class BindablePropChangedEvent<T>
    {
        public T oldVal;
        public T newVal;
    }
    ...
    public class BindablePropertyUnRegister<T> : IUnRegister
    {
        ...
        public Action<BindablePropChangedEvent<T>> _onValueChanged { get; set; }
    }
    #endregion
