...
public class SkillLibrary
{
    ...
    static SkillLibrary()
    {
        ...
        // 添加技能到字典
        AddSkill(new Skill("普攻", "attack", 0, 1, 1, 0.5f, 0.33f, 0.1f, 0, false, true, new DoNotRemoveStatuses(), new DoNotAddStatusEffect(), new NoTargetRequired(), new NoMovement(), new FaceTargetHitCheck(2.5f), new DoNotAddBuff()));
        ...
        AddSkill(new Skill("潜行", "qianxing", 0, 0, 1, 6f, 0.33f, 0.3f, 0, false, false, new DoNotRemoveStatuses(), new DoNotAddStatusEffect(), new TargetRequired(6f), new RushToTargetMovement(), new FaceTargetHitCheck(2.5f), new DoNotAddBuff()));
