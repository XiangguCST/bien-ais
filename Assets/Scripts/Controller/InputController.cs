...
public class InputController : MonoSingleton<InputController>
{
    void Awake()
    {
        ...
        _skillBar1.AttachSkill(KeyCode.U, new Skill("潜行", "qianxing", 0, 0, 1, 6f, 0.33f, 0.3f, 0, false, false, new DoNotRemoveStatuses(), new DoNotAddStatusEffect(), new TargetRequired(6f), new RushToTargetMovement(), new FaceTargetHitCheck(2.5f), new DoNotAddBuff()));
        _skillBar1.AttachSkill(KeyCode.I, new Skill("莲华脚", "lianhuajiao", 2, 0, 12, 24f, 0.22f, 0.2f, 0, false, true, new DoNotRemoveStatuses(), new AddStatusEffect(CharacterStatusType.Stun, 2f), new TargetRequired(6f), new RushToTargetMovement(), new RangeHitCheck(-1f), new AddBuffDuration(BuffType.ImmunityAll, 1)));
        ...
        _skillBar2.AttachSkill(KeyCode.Keypad4, new Skill("潜行", "qianxing", 0, 0, 1, 6f, 0.33f, 0.3f, 0, false, false, new DoNotRemoveStatuses(), new DoNotAddStatusEffect(), new TargetRequired(6f), new RushToTargetMovement(), new FaceTargetHitCheck(2.5f), new DoNotAddBuff()));
        _skillBar2.AttachSkill(KeyCode.Keypad5, new Skill("莲华脚", "lianhuajiao", 2, 0, 12, 24f, 0.22f, 0.2f, 0, false, true, new DoNotRemoveStatuses(), new AddStatusEffect(CharacterStatusType.Stun, 2f), new TargetRequired(6f), new RushToTargetMovement(), new RangeHitCheck(-1f), new AddBuffDuration(BuffType.ImmunityAll, 1)));
